...
# Create LAN
set lan [$ns make-lan $lannode_list 10Mb 2ms LL Queue/DropTail Mac/802_3 Channel]


# Create Topology
$ns duplex-link $nodeA $lannode(0) 10Mb 1ms DropTail
$ns duplex-link $nodeB $lannode(1) 20Mb 1ms DropTail


# Set NAM positions
$ns duplex-link-op $nodeA $lannode(0) orient right
$ns duplex-link-op $nodeB $lannode(1) orient left
